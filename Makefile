...
#    Updated: 2024/09/11 11:00:33 by jopfeiff         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = lexer/lexer.c lexer/init_lexer.c parser/parsing_error.c parser/parser_utils.c main.c builtins/echo.c parser/parser.c lexer/lexer_utils.c \
	 builtins/ft_utiles_echo.c builtins/pwd.c builtins/cd.c builtins/builtins.c builtins/ft_utiles_echo2.c redirections/environment.c redirections/export.c
CC = cc
